...
Receive early notifications for priority access to your WRLD CHNGR NFT
              ...
              <div className="text-center">
                <input type="submit" name="subscribe" id="mc-embedded-subscribe" className="mt-2 w-full font-pro bg-[#EA580C] hover:bg-indigo-500 text-indigo-200 font-bold py-4 px-4 shadow-md border-black rounded" value="Get Notified of Drop" />
              </div>
            </div>
          </form>
        </div>
